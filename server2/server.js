...
function getStream(call) {
	var result = []
	result.push({id: "5a0cae787f21fa41607cdd19", name: 'stream01', description: 'description'})
	result.push({id: "5a0cae787f31fa41607cdd19", name: 'stream02', description: 'description'})
	result.push({id: "5a0cae787f31fa41607cdd19", name: 'stream03', description: 'description'})
	result.push({id: "5a0cae787f31fa41607cdd19", name: 'stream04', description: 'description'})
	result.push({id: "5a0cae787f31fa41607cdd19", name: 'stream05', description: 'description'})
	result.push({id: "5a0cae787f31fa41607cdd19", name: 'stream06', description: 'description'})
	result.push({id: "5a0cae787f31fa41607cdd19", name: 'stream07', description: 'description'})
...
server.addService(proto.Channel.service, {getAll: getAll, prueba: getPrueba, streamTest: getStream});
